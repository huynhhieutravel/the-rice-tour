...
```mermaid
graph TD
    Market["TÂM ĐIỂM CHỢ BẾN THÀNH"]
    Market --> South["CỬA NAM: Vải vóc, Áo dài may đo lấy liền, Sơn mài, Đồ thủ công mỹ nghệ"]
    Market --> East["CỬA ĐÔNG: Cà phê rang xay, Trà sâm, Bánh mứt, Hạt điều, Tiêu Phú Quốc, Hải sản khô"]
    Market --> West["CỬA TÂY: Giày dép da thủ công, Túi xách mây tre đan, Thổ cẩm, Nón lá trang trí"]
