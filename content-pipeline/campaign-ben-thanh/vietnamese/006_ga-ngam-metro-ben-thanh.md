...
```mermaid
graph TD
    Surface["Mặt đất: Quảng trường Quách Thị Trang & Giếng trời hoa sen Toplight"]
    Surface --> B1["Tầng B1: Sảnh vé, Cổng soát thẻ NFC, Phố thương mại ngầm"]
    B1 --> B2["Tầng B2: Ke ga Tuyến 1 (Đón tàu đi Nhà hát TP - Ba Son - Thảo Điền - Suối Tiên)"]
    B2 --> B3["Tầng B3: Tầng kỹ thuật điều hành & Sảnh trung chuyển sang Tuyến 2"]
