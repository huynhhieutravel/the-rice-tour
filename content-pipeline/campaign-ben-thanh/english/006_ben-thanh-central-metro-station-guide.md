...
categories: ["Urban Architecture", "Saigon Travel Guides", "Transit Logistics"]
tags: ["Saigon Metro", "Ben Thanh Station", "Line 1 Metro", "Lotus Skylight", "District 1", "Bespoke Travel"]
badges:
  - icon: "🚇"
    text: "Four-Tier Subterranean Hub"
  - icon: "🪷"
    text: "21m Lotus Glass Toplight"
  - icon: "⚡"
    text: "14-Min Transit to Thao Dien"
  - icon: "🌿"
    text: "2026 Rapid Transit Notes"
stats:
  - icon: "📍"
    label: "Station Coordinates"
    val: "Quach Thi Trang Plaza, District 1"
  - icon: "📐"
    label: "Scale & Depth"
    val: "32m Deep (4 Underground Levels), 236m Length"
  - icon: "🕒"
    label: "Operating Schedule"
    val: "05:00 AM – 23:00 PM (4–8 min intervals)"
  - icon: "🎟️"
    label: "2026 Tariff Baseline"
    val: "7,000 – 20,000 VND (Day Pass: 40,000 VND)"
sidebar_facts:
  - icon: "📍"
    label: "Intermodal Node"
    val: "Terminal for Lines 1, 2, 3A & 4"
  - icon: "🌤️"
    label: "Golden Architectural Light"
    val: "16:00 – 17:30 PM (Dusk Sunbeams)"
  - icon: "💳"
    label: "Transit Payment"
    val: "EMV Tap-to-Pay, IC Smart Cards & QR"
  - icon: "❄️"
