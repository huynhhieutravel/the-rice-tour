...
categories: ["Sacred Sanctuaries", "Saigon Travel Guides", "Cultural Heritage"]
tags: ["Mariamman Temple", "Hindu Temple Saigon", "Dravidian Architecture", "District 1", "Tamil Heritage", "Bespoke Travel"]
badges:
  - icon: "🕉️"
    text: "Centennial Tamil Heritage"
  - icon: "🏛️"
    text: "Dravidian Gopuram Artistry"
  - icon: "🪨"
    text: "Sacred Stone Ritual"
  - icon: "🌿"
    text: "2026 Curated Spiritual Stroll"
stats:
  - icon: "📍"
    label: "Temple Coordinates"
    val: "45 Truong Dinh, District 1"
  - icon: "🕉️"
    label: "Deity Enshrined"
    val: "Goddess Mariamman (Mother Earth)"
  - icon: "⏳"
    label: "Construction Era"
    val: "Early 20th Century (Tamil Chettiar)"
  - icon: "🎟️"
    label: "Admission Baseline"
    val: "Free Admission (Voluntary Offering)"
sidebar_facts:
  - icon: "📍"
    label: "Market Proximity"
    val: "200 meters from West Gate"
  - icon: "🌤️"
    label: "Tranquil Hours"
    val: "08:00 – 10:00 AM (Morning Puja)"
  - icon: "🥾"
    label: "Sacred Protocol"
    val: "Footwear removal mandatory at entry"
  - icon: "🌺"
...
- **100+ Years of Unbroken Worship:** Erected by Tamil Chettiar merchants in the early 1900s upon the site of an earlier humble timber shrine.
- **200-Meter Proximity:** An effortless three-minute walk from Ben Thanh Market, tucked between quiet boutique shops and leafy cafe alleyways.
- **Dozens of Hand-Carved Deities:** Embellishing the 12-meter-high Gopuram pyramid gateway, sculpted according to ancient Tamil sacred canons.
- **Tri-Cultural Devotion:** A rare sacred space where ethnic Indian, Vietnamese, and Chinese devotees pray side by side in mutual reverence.
- **The Singular Stone-Pressing Ritual:** A contemplative local custom of pressing one's forehead and palms against the rear granite sanctum wall to absorb positive vibrations.
...
| :--- | :--- | :--- | :--- |
| **The Gopuram Gateway** | Exterior Facade | Sculpted Hindu pantheon, Shiva, Ganesha | Admire multi-tiered South Indian bas-reliefs |
| **Central Sanctum** | Heart of Main Hall | Black stone Goddess Mariamman | Witness morning incense rituals & marigold offerings |
| **Rear Granite Wall** | Behind Inner Altar | Chanted-infused structural granite | Practice the meditative stone-pressing prayer |
| **Lord Ganesha Shrine** | Left Mezzanine | Elephant-headed deity of intellect | Seek auspicious blessings for education & commerce |
| **The Silver Chariot** | Side Pavilion | Elaborate 20th-century embossed silver carriage | Inspect the regal carriage used in annual festival processions |
