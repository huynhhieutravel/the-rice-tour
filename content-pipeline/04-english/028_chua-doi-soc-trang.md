...
sidebar_facts:
  - label: "The Heartland"
    value: "Ward 3, Soc Trang City"
    icon: "📍"
  - label: "Best Visiting Time"
    value: "Early Morning or Late Afternoon (17:00)"
    icon: "🌤️"
  - label: "Signature Experiences"
    value: "Bat Watching, Architecture Tour, Serene Walks"
    icon: "📸"
  - label: "Heritage Inscription"
    value: "National Architectural and Artistic Relic (1999)"
    icon: "📜"
---
...
Approaching the Main Hall, visitors are greeted by a striking, multi-tiered roof painted in brilliant shades of gold and orange, designed to resemble a stylized Naga (serpent) slithering downwards. The Naga represents protection and the bridge between the human world and the heavens.
Inside, the hall houses a massive monolithic stone Buddha statue resting on a lotus pedestal. The walls are covered in vivid murals depicting the life journey of Siddhartha Gautama—from his birth to his attainment of Nirvana.
...
- **Getting There:** The pagoda is located just 3 kilometers from the center of Soc Trang City. It is easily accessible by taxi, xe ôm (motorbike taxi), or even a rented bicycle.
- **Etiquette:** 
  - **Do NOT disturb the bats.** Do not throw objects, shine bright lights, or make loud noises to wake them up during the day.
...
> 🚐 **Embark on a Mystical Journey with The Rice Tour**
> Delve into the rich cultural and natural mysteries of Soc Trang. Our expert-guided Mekong Delta itineraries offer deep cultural context, ensuring your visit to the Bat Pagoda is respectful, insightful, and entirely unforgettable. Connect with The Rice Tour today.
