...
import { ALASKA_TOC } from '../data/alaskaData';
...
export default function SeriesNavigation({ currentPart }: Props) {
  ...
  const nextItem = ALASKA_TOC.find(i => i.part === nextPart) || ALASKA_TOC[0];
    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16 mt-8 border-t border-white/10">
        ...
        <div className="mt-8 bg-[#0D1516] border border-[#162527] rounded-3xl p-8 md:p-12 text-center relative overflow-hidden group">
          <div className="absolute inset-0 bg-[url('https://media.fittour.vn/uploads/song-bang-va-day-nui-tuyet-alaska.webp')] bg-cover bg-center opacity-10 mix-blend-luminosity group-hover:opacity-20 transition-opacity duration-700" />
          <div className="relative z-10 space-y-6">
            ...
            <p className="text-stone-400 max-w-xl mx-auto text-sm md:text-base leading-relaxed">
              Khám phá Hành trình Tour Alaska 8 Ngày 7 Đêm cao cấp. Tận mắt chiêm ngưỡng sông băng vĩnh cửu, chinh phục Denali và ngắm nhìn gấu nâu hoang dã.
            </p>
            <a 
              href="https://thericetour.com/tour/tour-alaska-8n7d" 
              target="_blank" 
      ...
      <button 
        ...
        aria-label="Mục lục Series Alaska"
