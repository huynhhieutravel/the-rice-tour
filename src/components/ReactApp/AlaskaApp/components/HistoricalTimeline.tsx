...
import { ALASKA_TIMELINE } from '../data/alaskaData';
import type { HistoricalEvent } from '../types';

export default function HistoricalTimeline() {
  const [selectedEvent, setSelectedEvent] = useState<HistoricalEvent>(ALASKA_TIMELINE[0]);

  return (
    <div id="alaska-historical-engravings" className="bg-[#121B1C]/90 rounded-3xl border border-white/10 p-6 md:p-8 text-white text-left relative overflow-hidden">
