...
import ReasonsGuide from './components/ReasonsGuide';
...
export default function LyDoChonFitTourLadakh({ seoDescription }: { seoDescription?: string }) {
  ...
  return (
    <div className="min-h-screen bg-stone-50 text-stone-800 font-sans selection:bg-amber-150 selection:text-amber-900 overflow-x-hidden antialiased">
      ...
      <main className="min-h-[70vh]">
        <ReasonsGuide onTourSelect={setBookingTour} seoDescription={seoDescription} />
      </main>
