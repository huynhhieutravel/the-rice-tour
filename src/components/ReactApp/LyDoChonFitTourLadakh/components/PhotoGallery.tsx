      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="max-w-2xl mx-auto text-sm text-stone-600 font-sans">
            ...
            Xem qua lăng kính mộc mạc lưu dấu những bến bờ tuyết sương của Ladakh.
          </p>
        </div>
          ...
          <AnimatePresence mode="popLayout">
            {filteredPhotos.map((photo, index) => (
              ...
              >
                ...
                {/* Photo frame */}
                <div className="relative aspect-4/3 overflow-hidden bg-stone-100 group cursor-pointer border border-stone-100 rounded-sm">
                  <img
                    src={photo.url}
                    alt={photo.caption}
                ...
                <div className="mt-5 text-left pl-1">
                  <div className="flex items-center gap-2 text-stone-400 text-[10px] font-mono mb-1.5">
        ...
        <AnimatePresence>
          {selectedPhoto && (
            ...
            >
              ...
              >
                {/* Photo Column */}
                <div className="md:col-span-7 bg-stone-950 aspect-4/3 md:aspect-auto md:h-[500px]">
                  <img
                  ...
                  <div>
                    ...
                    <div className="space-y-3 mb-6">
                      <div className="flex items-center gap-2.5 text-xs text-stone-500 font-mono">
                        ...
                        <div>
                          <span className="block text-[9px] uppercase text-stone-400">Tọa độ ghi ảnh</span>
                      ...
                      <div className="flex items-center gap-2.5 text-xs text-stone-500 font-mono">
                        ...
                        <div>
                          <span className="block text-[9px] uppercase text-stone-400">Thời gian thực tế</span>
                    ...
                    {/* Captions list */}
                    <h4 className="font-mono text-[9px] text-stone-400 uppercase tracking-widest block mb-2">Lời tự bạch</h4>
                    <p className="font-serif text-base text-stone-800 leading-relaxed font-semibold italic">
                      "{selectedPhoto.caption}"
                    </p>
                  </div>

                  <div className="pt-6 mt-6 border-t border-stone-100 flex items-center justify-between text-xs font-mono text-stone-400">
                    <div className="flex items-center gap-1">
                      <Camera className="w-4 h-4 text-stone-400" />
                      <span>Himalaya Diaries U70</span>
                    </div>
                    <button
                      onClick={() => setSelectedPhoto(null)}
