...
export default function SayDoCaoChecklist() {
  ...
  const fullGear = [
    { id: 'water', vietnameseName: 'Uống Thật Nhiều Nước', necessity: 'critical', description: 'Tăng cường uống nước (3-4 lít/ngày) để bù nước ở vùng không khí loãng.', iconName: 'Coffee' },
    { id: 'medicine', vietnameseName: 'Thuốc Say Độ Cao', necessity: 'critical', description: 'Sử dụng thuốc (như Diamox) theo chỉ định bác sĩ để cơ thể không bị sốc.', iconName: 'Pill' },
    { id: 'sleep', vietnameseName: 'Leo Cao, Ngủ Thấp', necessity: 'critical', description: 'Tránh ngủ đêm ở độ cao lớn ngay ngày đầu tiên để cơ thể thích nghi dần.', iconName: 'ThermometerSun' },
    { id: 'no_shower', vietnameseName: 'Tránh Tắm Gội Sớm', necessity: 'recommended', description: 'Giữ ấm cơ thể, không tắm rửa ngay khi mới hạ cánh ở vùng lạnh để ngừa ngất xỉu.', iconName: 'Flame' },
    { id: 'walk_slow', vietnameseName: 'Di Chuyển Chậm Rãi', necessity: 'recommended', description: 'Hạn chế vận động mạnh, đi đứng nhẹ nhàng, không nhảy nhót hay chạy bộ.', iconName: 'Footprints' },
  ];
  ...
  return (
    <div id="saydocao-survival-checklist" className="bg-white rounded-3xl border border-gray-200 p-5 md:p-8 text-gray-800 text-left relative overflow-hidden shadow-sm my-12 font-sans max-w-4xl mx-auto">
