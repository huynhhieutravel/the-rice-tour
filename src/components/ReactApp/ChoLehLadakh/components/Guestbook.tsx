...
const INITIAL_MESSAGES: GuestbookMessage[] = [
  {
    ...
    message: 'Mua sắm ở chợ Leh là một trải nghiệm tuyệt vời, không ồn ào và được tận hưởng nhịp sống chậm rãi hiếm có!',
  ...
  },
  {
    ...
    message: 'Vừa đi tour Ladakh về xong, tôi cực kỳ tâm đắc với bài viết này. Đi dạo ở chợ Leh vào buổi chiều tối mang lại cảm giác rất thanh bình. Gia đình tôi đã mua được rất nhiều khăn Pashmina và quả mơ sấy về làm quà cho họ hàng. Bà xã tôi đặc biệt thích chiếc chuông xoay Tây Tạng mua ở đầu hẻm.',
  ...
  },
  {
    id: 'm-3',
    name: 'Minh Quân',
    message: 'Rất cảm ơn tác giả đã chia sẻ cẩm nang siêu chi tiết! Nhờ đọc bài viết này mà chuyến đi tự túc vừa rồi của nhóm tụi mình đã né được rất nhiều bẫy mua hớ ở chợ. Mình đã mua được tuýp kem Himalaya cứu cánh cho đôi môi nứt nẻ chỉ với giá rất rẻ tại một tiệm thuốc nhỏ.',
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="font-serif text-3xl md:text-4xl font-bold text-stone-900 leading-tight">
            Cẩm Nang Bỏ Túi & Trải Nghiệm Thực Tế
          </h2>
          ...
          <p className="max-w-2xl mx-auto text-sm text-stone-600 font-sans">
            Chia sẻ những kỷ niệm mua sắm thú vị và kinh nghiệm dạo chợ thực tế từ chuyến đi của bạn.
          </p>
        </div>
          ...
          <div className="lg:col-span-5 bg-white p-6 md:p-8 rounded-2xl shadow-md border border-amber-900/10 relative h-fit">
            ...
            <div className="space-y-4">
              <p className="text-sm font-sans text-stone-600 leading-relaxed">
                Chợ Leh - bức tranh thu nhỏ của nhịp sống bản địa giữa lòng Himalaya. Từng con hẻm, từng sạp hàng đều mang theo câu chuyện của người vùng cao.
              </p>
