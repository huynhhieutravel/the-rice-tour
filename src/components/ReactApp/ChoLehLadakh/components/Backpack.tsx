    ...
    <section id="backpack-section" className="relative py-24 px-4 bg-stone-900 text-stone-150 border-t border-stone-800">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          <span className="font-mono text-xs uppercase tracking-widest text-amber-500 font-bold block mb-2">Hành Trang Đi Chợ</span>
          <h2 className="font-serif text-3xl md:text-4xl font-bold text-white tracking-tight leading-tight">
            Túi Đồ Thiết Yếu Khi Dạo Chợ Leh
          </h2>
          ...
          <p className="max-w-2xl mx-auto text-sm text-stone-400 font-sans">
            Dạo bước trên phố cổ đi bộ, dưới đây là những vật dụng thiết yếu bạn nên chuẩn bị sẵn trong túi cá nhân để có một buổi chiều mua sắm trọn vẹn và an toàn nhất.
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-2 mb-10">
          {[
            ...
            { id: 'health', label: 'Y Tế Cơ Bản', icon: Heart },
            { id: 'essential', label: 'Thực Phẩm & Tiện Ích', icon: ShieldCheck },
            { id: 'gear', label: 'Đồ Mặc & Lưu Niệm', icon: Gift },
          ].map(cat => {
            const Icon = cat.icon;
                  ...
                  >
                    <div className="flex justify-between items-start mb-3">
                      <span className={`text-[9px] font-mono font-bold px-2 py-0.5 rounded-full border ${badgeColor}`}>
                        {item.category === 'health' ? 'Y Tế' : item.category === 'essential' ? 'Thiết Yếu' : 'Lưu Niệm'}
                      </span>
                    ...
                    <div className="space-y-3 font-sans text-xs">
                      ...
                      <div className="flex justify-between py-2 border-b border-stone-800 text-stone-400">
                        ...
                        <span className="font-semibold text-white">
                          {selectedItem.category === 'health' ? '🛡️ Bảo vệ sức khỏe' : selectedItem.category === 'essential' ? '🎒 Tiện ích cá nhân' : '❤️ Đồ chống lạnh / Lưu niệm'}
                        </span>
                      </div>
