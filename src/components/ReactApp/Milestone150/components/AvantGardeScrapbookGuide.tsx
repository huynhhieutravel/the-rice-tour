...
const EXPERIENCES = [
  ...
  },
  {
    ...
    subtitle: "Mối quan hệ chính thức cấp cao tại thủ phủ Leh Himalaya",
    icon: Landmark,
  ...
  },
  {
    ...
    icon: ShieldCheck,
    color: "bg-blue-400",
    content: "Phụ huynh 70 tuổi khát vọng chinh phục Himalaya hoang sơ nhưng lo sợ tim rệu rã. Fit Tour sưởi ấm tâm hồn họ bằng chăn nhiệt điện sưởi êm giữa đêm hoang mạc âm 10 độ, phác đồ bách bộ từng chặng nâng niu như người thân của chính mình.",
...
const MILESTONES = [
  ...
  },
  {
    ...
    desc: "Đột phá đưa mô hình lều VIP Glamping vách cách lạt chống bão, sưởi ấm đệm điện hừng hực nhiệt đới bờ hồ Bhutan Tso lạnh vạn năm.",
  ...
  },
  {
    ...
    desc: "Đúc kết từ 150 hành trình điêu luyện để ban hành bộ luật An toàn 5 lớp đặc hiệu chống AMS hữu hiệu nhất Việt Nam.",
...
const DETAILED_LAYERS = [
  ...
  },
  {
    ...
    desc: "Bình oxy bọc sườn khí sục lắp đặt trên mọi chiếc xe 4x4 vượt đèo Tây Tạng.",
...
const RAW_TOASTS = [
  {
    ...
    quote: "Phải đi qua những cung đường Himalaya loãng khí lạnh tanh mới thấy trân quý sự khắt khe y học từ Fit Tour. Không hô hào khẩu hiệu suông, họ giải quyết bài toán AMS cực kỳ khoa học bằng oxy nén dồi dào trên xe. 150 chuyến lý nghiệm là hoàn toàn xứng đáng!"
  },
  {
    tag: "ĐOÀN KHỞI HÀNH THỨ 49",
    author: "Cô Lê Thị Thanh (64 tuổi, Ba Đình, Hà Nội)",
    quote: "Mấy đứa bảo mệt lắm không đi nổi đâu nhưng đi Fit Tour được các cháu chăm chút nước gừng ấm tối tối, lều ven hồ Bhutan chăn ấm rực điện ấm áp êm ru. Tôi đi về chẳng sốt chảAMS tí nào. Chúc mừng các cháu đạt mốc 80 rực rỡ!"
  },
  {
        ...
        <div className="relative z-10 max-w-6xl mx-auto space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p className="font-sans text-stone-200 text-base sm:text-2xl font-light leading-snug max-w-3xl italic border-l-4 border-orange-450 border-l-orange-500 pl-4">
              ...
              Bạn muốn chinh phục vùng đất chết an sinh, bạn buộc phải tin vào kẻ thực chiến dắt đoàn 150 hành trình hoàn mỹ.”
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4">
            ...
            <div className="bg-stone-900 border-2 border-stone-800 p-4 rounded-none">
              ...
              <p className="text-[11px] text-stone-400 mt-1">Kháng lạnh bờ hồ muối vạn năm Bhutan âm 10 độ.</p>
            </div>
          </div>
        ...
        <div className="bg-amber-450 bg-amber-250 border-4 border-stone-950 p-6 sm:p-10 bg-yellow-50 relative shadow-[8px_8px_0px_0px_#1c1917]">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start gap-6 border-b-4 border-stone-950 pb-6 mb-8">
            ...
            <p className="text-stone-700 text-sm sm:text-base font-sans max-w-sm font-semibold opacity-90 leading-normal text-justify">
              “Chúng tôi rà quét và kiến thiết thành tựu 150 hành trình bằng máu, tuyết và y pháp độc quyền, tuyệt đối từ chối copy dán.”
            </p>
          </div>
        ...
        <div className="border-4 border-stone-950 bg-stone-950 text-white p-6 sm:p-10 shadow-[8px_8px_0px_0px_#101010]">
          ...
          <div className="space-y-2 mb-10 max-w-3xl">
            ...
            <p className="text-stone-400 text-sm sm:text-base font-sans">
              150 hành trình là chặng đường lữ hành thô mộc rèn giũa từ thời chưa phủ ấm đến thời phủ lều sưởi nhiệt điện và liên hệ Không quân trực tiếp:
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <div className="text-center max-w-3xl mx-auto space-y-2">
            ...
            <p className="text-stone-600 font-serif text-base sm:text-base italic">
              Vực lạnh Himalaya khắc nghiệt không dành cho những bài chia sẻ vu vơ của dân đi bụi. Đi cùng gia đình, hãy đặt niềm tin vào quy chuẩn cứng cáp sau:
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-stretch">
            ...
            <div className="p-6 border-4 border-stone-950 bg-orange-400 flex flex-col justify-between items-start text-stone-950 shadow-[6px_6px_0px_0px_#1c1917]">
              ...
              <button
                onClick={() => {
                  onTourSelect?.({
                    title: "Bao sườn Tầm soát Y tế AMS Lâm sàng Himalaya U70",
            ...
            {!wishDone ? (
              ...
              <div className="p-6 border-2 border-dashed border-stone-950 bg-white text-center space-y-3">
                ...
                <p className="text-xs text-stone-600 leading-normal font-sans">
                  Lời chúc đã được lưu bút của bạn đã dán thẳng lên bảng kỷ niệm vàng mốc 150 hành trình của thương hiệu.
                </p>
                <button
      ...
      <section className="bg-white border-4 border-stone-950 p-6 sm:p-10 shadow-[6px_6px_0px_0px_#101010]">
        <div className="max-w-4xl mx-auto space-y-8 text-left">
          ...
          <div className="space-y-4">
            {[
              {
                q: "Vì sao 150 chuyến thực nghiệm dã ngoại quý giá hơn vạn bài cẩm nang mạng?",
              ...
              {
                q: "Làm sao bảo vệ sức khỏe cho cha mẹ đi dã ngoại âm 10 độ ở hồ muối Bhutan?",
