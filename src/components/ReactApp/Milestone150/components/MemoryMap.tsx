...
import type { HimalayaLocation } from '../types';
import { MapPin, Compass, Thermometer, ChevronRight, Activity, ArrowRight } from 'lucide-react';

export default function MemoryMap() {
  const [selectedLocation, setSelectedLocation] = useState<HimalayaLocation>(LOCATIONS[0]);
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="max-w-2xl mx-auto text-sm text-stone-600 font-sans">
            ...
            nhiệt độ thực tế, cùng độ cao rợn ngợp của dãy Tây Tạng mà đội ngũ FIT Tour đã an tâm dẫn lối.
          </p>
        </div>
          ...
          <div className="lg:col-span-7 bg-stone-900 rounded-2xl p-6 shadow-xl relative overflow-hidden flex flex-col justify-between border border-stone-800">
            ...
            <div className="relative z-10 flex items-center justify-between border-b border-stone-800 pb-4 mb-4">
              <div className="flex items-center gap-2">
                ...
                <span className="font-mono text-xs uppercase tracking-wider text-stone-300 font-semibold">Himalaya Route Map</span>
              </div>
            ...
            <div className="relative aspect-16/10 w-full bg-stone-950/80 rounded-xl overflow-hidden border border-stone-800/80 p-2">
              ...
              <div className="absolute bottom-3 left-4 z-10 text-[10px] font-mono text-stone-500 flex flex-col gap-0.5 pointer-events-none">
                <span>Rặng Karakoram-Himalaya Bản Đồ Địa Hình</span>
                <span>Tọa độ viễn du thực tế trong lộ trình 150 hành trình</span>
              </div>
            ...
            <div className="relative z-10 flex flex-wrap gap-4 mt-4 pt-4 border-t border-stone-800 text-xs font-mono">
              ...
              <div className="flex items-center gap-1.5 text-stone-400">
                ...
                <span>Điểm Cuối: <b>Bhutan Lake</b></span>
              </div>
          ...
          <div className="lg:col-span-5 flex flex-col justify-between">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div>
                  ...
                  <div className="flex justify-between items-start border-b border-amber-900/10 pb-4 mb-5">
                    ...
                    <div className="text-right">
                      <span className="text-[10px] font-mono text-stone-500 block">Độ Cao</span>
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-6">
                    <div className="bg-stone-900/5 border border-stone-950/5 rounded-xl p-3 flex items-center gap-2">
                      ...
                      <div>
                        <span className="text-[9px] font-mono text-stone-500 block uppercase">Nhiệt độ</span>
                    ...
                    <div className="bg-stone-900/5 border border-stone-950/5 rounded-xl p-3 flex items-center gap-2">
                      ...
                      <div>
                        <span className="text-[9px] font-mono text-stone-500 block uppercase">Hiệu ứng</span>
                ...
                <div className="mt-8 pt-4 border-t border-amber-900/10 flex items-center justify-between text-[11px] font-mono text-stone-500">
                  <div className="flex items-center gap-1">
                    <span className="w-1.5 h-1.5 bg-amber-600 rounded-full"></span>
                    <span>Nhật ký hành trình từ Trưởng đoàn FIT Tour</span>
                  </div>
