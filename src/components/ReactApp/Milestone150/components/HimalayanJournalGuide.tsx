...
const LEDGER_PAGES = [
  {
    ...
    content: "Suốt 9 năm dòng dã với 80 đợt trực tiếp chinh phạt dốc tuyết cao hẹp của Himalaya, Fit Tour sở hữu trực giác thực địa của những thợ săn bão tuyết kì cựu. Người dẫn đường am tường từng gờ đá nứt vụn, ngửi thấy hướng gió bấc tràn hiểm ác để dẫn dắt gia đình bạn lùi bước kịp thời trước vách sạt lở.",
  ...
  },
  {
    ...
    botanicalNote: "❖ Cảnh Báo Lâm Sàng: Lên đèo Tây Tạng (5.359m) tốc hành không có phác đồ y tế dễ gây bục phế huyết bản."
  },
  {
    id: "army",
  ...
  },
  {
    ...
    chapter: "BẢN THẢO 04",
    title: "Kỳ Tích Chống Lạnh Âm 10 Độ Tại Hồ Bhutan",
    subtitle: "Sứ mệnh đưa bố mẹ ngự trên nóc nhà thế giới an nhiên",
    content: "Nhiều người nghĩ tuổi 70 không thể đón sao trời bên hồ muối Bhutan ẩm buốt. Fit Tour kiến thiết lều nệm sưởi điện nhiệt đới kẹp trong lều Glamping VIP hai lớp độc quyền, trà gừng hâm nóng liên tục 2 giờ một lần, xe SUV 4x4 xịn bọc nỉ kín gió. Biến ước vọng của bố mẹ thành sự thật trong giấc ngủ say nồng, ấm áp.",
...
const ARCHIVAL_POSTCARDS = [
  {
    ...
    title: "Tuyển Tập Himalaya – Đèn Trời Milky Way Bhutan Tso",
    duration: "10 ngày / 9 đêm dã ngoại thượng đỉnh",
    price: "35.500.000 vnđ",
    experience: "Cung đường cực đỉnh dung hòa y tế 5 lớp vững chãi. Trải nghiệm trọn sưởi lều hồ Bhutan lạnh giá, thảnh thơi vượt đèo Tây Tạng trên SUV đời mới.",
    notes: [
        ...
        <header className="border-4 border-double border-amber-900/60 p-6 sm:p-10 bg-[#f7f2ea] rounded-2xl relative shadow-[10px_10px_0px_rgba(120,53,15,0.06)] text-center">
          ...
          <div className="space-y-4">
            <span className="font-serif italic text-base sm:text-xl text-amber-800 tracking-wide block">
              Tư liệu lưu trữ chín năm thực chứng Himalaya dốc tuyết
            </span>
        ...
        <section className="border-4 border-double border-amber-900/40 p-6 sm:p-10 bg-[#fbf7f1] rounded-2xl relative shadow-md">
          ...
          <div className="max-w-xl mx-auto text-center space-y-2 mb-12">
            ...
            <h2 className="font-serif font-extrabold text-2xl sm:text-4xl text-stone-900 leading-tight uppercase">
              Bản Đồ Đối Chiếu Khí Áp Himalaya
            </h2>
