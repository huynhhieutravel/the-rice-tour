    ...
    <section id="backpack-section" className="relative py-24 px-4 bg-stone-900 text-stone-150 border-t border-stone-800">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          <span className="font-mono text-xs uppercase tracking-widest text-amber-500 font-bold block mb-2">Hành Trang Leo Núi</span>
          <h2 className="font-serif text-3xl md:text-4xl font-bold text-white tracking-tight leading-tight">
            Có Gì Trong Hành Lý Người Thợ Săn Mây U70?
          </h2>
          ...
          <p className="max-w-2xl mx-auto text-sm text-stone-400 font-sans">
            Không phải lều trại hầm hố hay gậy leo núi chuyên nghiệp, túi đồ của Cô Mây là sự dung hòa giữa 
            những tính toán y khoa nghiêm ngặt, vị ấm sả gừng mộc mạc và cả những điểm tựa tâm linh gửi gắm nơi quê nhà.
          </p>
        </div>
                ...
                return (
                  ...
                  >
                    <div className="flex justify-between items-start mb-3">
                      ...
                      <span className="text-[10px] font-mono text-stone-500 font-semibold">{item.qty}</span>
                    </div>
                    ...
                    <div className="flex items-center justify-between text-xs font-mono">
                      <span className="text-stone-500">Độ cần thiết:</span>
              ...
              {selectedItem ? (
                ...
                <div className="flex flex-col items-center justify-center text-center py-16 h-full">
                  ...
                  <p className="text-xs text-stone-400 max-w-xs leading-relaxed">
                    Hãy bấm vào một vật dụng bất kỳ trong túi đồ của Cô Mây để thấu hiểu câu chuyện ý nghĩa và vai trò thực tế của nó trong thời tiết lạnh giá khắc nghiệt.
                  </p>
                </div>
              )}
