...
const INITIAL_MESSAGES: GuestbookMessage[] = [
  ...
  },
  {
    id: 'm-3',
    name: 'Minh Quân',
    message: 'Ước mơ lớn nhất của con là năm mẹ con 65 tuổi có thể dẫn mẹ đi Ladakh giống như thế này. Đọc bài viết Emagazine của Cô mà con có động lực tích cóp tài chính và rèn luyện thể lực cho hai mẹ con ngay lập tức. Chúc Cô luôn là đám mây tự do dẻo dai bay đi muôn phương ạ!',
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="max-w-2xl mx-auto text-sm text-stone-600 font-sans">
            Những dặm đường của Cô Mây đã thắp lửa cho ước mơ của bạn như thế nào? Hãy viết vài lời sẻ chia, 
            gửi lời chúc sức khỏe dẻo dai đến Cô hoặc ghi dấu lại mơ ước hành trình của riêng bạn tại đây.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 bg-white p-6 md:p-8 rounded-2xl shadow-md border border-amber-900/10 relative h-fit">
            ...
            <div className="space-y-4">
              <p className="text-sm font-sans text-stone-600 leading-relaxed">
                Đừng chỉ là người xem qua màn ảnh. Dãy Himalaya, cao nguyên sỏi đá hùng vĩ và những tu viện cổ kính đang vẫy gọi bạn.
              </p>
          ...
          <div className="lg:col-span-12 xl:col-span-7 space-y-4 max-h-[520px] overflow-y-auto pr-2 no-scrollbar border-t md:border-t-0 pt-6 md:pt-0">
            <div className="flex items-center justify-between border-b border-stone-250/20 pb-3 mb-2">
              <span className="font-mono text-[10px] text-stone-600 font-bold uppercase tracking-wide flex items-center gap-1.5">
                <Smile className="w-4.5 h-4.5 text-amber-700" />
                Tổng số lời chúc hiện tại: <b>{messages.length}</b>
              </span>
              <span className="text-[10px] text-stone-600 italic">Kéo xuống để xem thêm</span>
            </div>
              ...
              {messages.map((m, index) => (
                ...
                >
                  ...
                  <div className="absolute top-4 right-4 flex items-center gap-1 opacity-0 group-hover:opacity-100 transition duration-300">
                    ...
                    <span className="text-[9px] font-mono font-bold text-stone-600">TRUYỀN CẢM HỨNG</span>
                  </div>
