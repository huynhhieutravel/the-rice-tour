...
export default function App({ featureImage }: AppProps) {
  ...
  const PORTRAIT_COVERS = [
    {
      title: "HUYẾT MẠCH LADAKH",
      vibe: "Kỳ vĩ và dạt dào",
      imageUrl: "https://media.fittour.vn/uploads/2022/06/khach-du-lich-di-ben-ho-pangong-tso.webp",
      quote: "Là dòng sông lịch sử vĩ đại, Indus mang đến sự sống cho toàn bộ nền văn minh thung lũng Leh hùng vĩ.",
      badge: "TRẢI NGHIỆM",
      coordinates: "34.1642° N, 77.5848° E",
      colorTheme: "border-amber-500 text-amber-400 bg-amber-500/10"
    },
    {
      title: "VƯỢT THÁC SÔNG BĂNG",
      vibe: "Cảm giác cực mạnh",
      imageUrl: "https://media.fittour.vn/uploads/2024/06/nha-nghi-canh-ho-pangong.webp",
      quote: "Trải nghiệm River Rafting trên những con sóng bạc đầu giữa hẻm núi sâu thẳm sẽ là ký ức không thể nào quên.",
      badge: "LƯU TRÚ",
    ...
    <div className="min-h-screen bg-stone-50 text-stone-800 font-sans selection:bg-amber-150 selection:text-amber-900 overflow-x-hidden antialiased">
      ...
      <header className="relative min-h-[100dvh] flex flex-col justify-between items-center bg-stone-950 text-white overflow-hidden p-6 md:p-8">
        ...
        <div className="absolute inset-0 z-0">
          <img
            src={featureImage || "https://media.fittour.vn/uploads/2021/11/song-indus.webp"}
            alt="Sông Indus hùng vĩ"
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto my-auto flex flex-col items-center">
          ...
          <div className="font-serif text-3xl md:text-4xl lg:text-5xl font-bold text-white tracking-tight leading-tight mb-6 text-center">
            ...
            >
              Sông Indus - Dòng Sông Tạo Nên Nền Văn Minh Himalaya
            </h1>
          </div>
          ...
          >
            Hành trình men theo bờ sông huyền thoại từ thượng nguồn Tây Tạng, khám phá điểm hợp lưu Sangam ngoạn mục và thử thách rafting vượt thác trên dòng nước băng giá ở độ cao 3500m.
          </motion.p>
          ...
          >
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span>Khám phá: <b>Sông Indus</b></span>
            </div>
            <span className="hidden sm:inline text-white/20">|</span>
            <div className="flex items-center gap-1.5">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="font-serif text-3xl md:text-4xl font-bold tracking-tight text-stone-900">
              Thông tin thiết yếu về Sông Indus
            </h2>
          ...
          <div className="space-y-6 text-stone-700 font-serif leading-relaxed text-base md:text-lg mb-12 text-justify">
            <p className="drop-cap">
              Sông Indus không chỉ là một trong những hệ thống sông dài nhất thế giới mà còn là linh hồn của vùng Ladakh. Chảy uốn lượn qua những hẻm núi cằn cỗi và thung lũng xanh tươi, dòng sông thiêng liêng này đã chứng kiến sự thăng trầm của hàng ngàn năm lịch sử, nơi những tu viện cổ kính nương mình bên vách đá vững chãi.
            </p>

            <div className="my-8 w-full rounded-2xl overflow-hidden shadow-xl border border-stone-200 relative group">
              <img 
                src={featureImage || "https://media.fittour.vn/uploads/cung-duong-ven-song-tai-sangam-view-point-ladakh.webp"} 
                alt="Vẻ đẹp ngoạn mục của Sông Indus" 
                width={1200}
                height={675}
            ...
            <p>
              Indus nổi tiếng với nền văn minh Thung lũng Indus (Indus Valley Civilization) cổ đại ở Pakistan và tây bắc Ấn Độ. Hệ thống sông Indus Leh thường xuyên được nuôi dưỡng bằng các sông băng và tuyết ở các dãy núi Himalaya, Hindu Kush và Karakoram của Tây Tạng, các phần phía bắc của Pakistan, và vùng lãnh thổ liên bang Ladakh.

Sự lưu thông của sông Indus Leh cũng được xác định bởi các mùa – nó làm giảm độ lạnh rất lớn, đồng thời lưu lượng nước tăng vọt khi có gió mùa (từ tháng 7 đến tháng 9).
            </p>
          </div>
              ...
              >
                {!hasImage ? (
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start relative">
                    <div className="lg:col-span-8 lg:col-start-3 space-y-8 text-center mx-auto max-w-3xl">
                      ...
                      <p className="font-mono text-sm text-amber-800 italic uppercase tracking-wider font-semibold">
                        {story.subtitle}
                      </p>

                      {story.quote && (
                        <div className="bg-gradient-to-br from-amber-50/80 to-stone-50 p-8 md:p-12 rounded-2xl border border-amber-950/5 shadow-inner w-full relative my-10 mx-auto transform hover:scale-[1.02] transition-transform duration-500">
                          <span className="font-serif text-6xl md:text-8xl leading-none text-amber-600/20 font-bold absolute top-2 md:top-4 left-4 md:left-6">“</span>
                          <p className="font-serif text-xl md:text-2xl text-stone-800 italic leading-relaxed relative z-10" dangerouslySetInnerHTML={{ __html: story.quote }} />
                        </div>
                      )}

                      <p className="font-serif font-semibold text-stone-600 text-base md:text-lg leading-relaxed italic bg-amber-50/40 p-4 md:p-6 rounded text-left border-l-4 border-amber-700" dangerouslySetInnerHTML={{ __html: story.abstract }} />

                      <div className="space-y-6 text-stone-700 text-base md:text-lg font-serif leading-relaxed text-justify md:text-left mt-8">
