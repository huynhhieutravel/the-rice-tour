...
export default function App() {
  ...
  const PORTRAIT_COVERS = [
    {
      title: "CUNG ĐƯỜNG HUYỀN THOẠI",
      vibe: "Khardung La, Chang La",
      imageUrl: "https://media.fittour.vn/uploads/deo-khardungla-tuyet-phu-trang-ladakh.webp",
      quote: "Đứng giữa những con đèo cao hơn 5.000 mét, nơi chỉ còn gió lạnh, núi non và bầu trời xanh bất tận.",
      badge: "ROAD TRIP",
    ...
    },
    {
      title: "HỒ NƯỚC BĂNG",
      vibe: "Pangong Lake",
      imageUrl: "https://media.fittour.vn/uploads/legacy/ho-pangong-ladakh.webp",
      quote: "Màu nước xanh ngọc thay đổi liên tục, rộng lớn và tĩnh lặng giữa cao nguyên khô cằn.",
      badge: "THIÊN NHIÊN",
    ...
    },
    {
      ...
      vibe: "Tu Viện Cổ & Người Du Mục",
      imageUrl: "https://media.fittour.vn/uploads/legacy/nguoi-dan-o-ladakh.webp",
      quote: "Những tu viện chênh vênh trên vách núi và cuộc sống du mục bền bỉ trên cao nguyên Changthang.",
      badge: "VĂN HÓA",
    ...
    <div className="min-h-screen bg-stone-50 text-stone-800 font-sans selection:bg-amber-150 selection:text-amber-900 overflow-x-hidden antialiased">
      ...
      <header className="relative h-screen flex flex-col justify-between items-center bg-stone-950 text-white overflow-hidden p-6 md:p-8">
        ...
        <div className="absolute inset-0 z-0">
          <img
            src="https://media.fittour.vn/uploads/check-in-chang-la-pass-ladakh.webp"
            alt="Mái nhà thế giới Himalaya"
        ...
        <div className="relative z-10 w-full flex items-center border-b border-white/10 pb-4 pt-4 max-w-7xl mx-auto text-xs font-mono tracking-widest text-stone-300">
          ...
          <ChevronRight className="w-3.5 h-3.5 mx-2 text-stone-500" />
          <span className="text-amber-400 font-bold truncate max-w-[200px] sm:max-w-none">Trải Nghiệm Ladakh</span>
        </div>
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto my-auto flex flex-col items-center">
          ...
          >
            ...
            <span>TOP 10 TRẢI NGHIỆM HIMALAYA</span>
          </motion.div>
          ...
          >
            Top 10 trải nghiệm du lịch Ladakh <span className="sr-only"> - </span> <br className="hidden sm:block" />
          ...
          <motion.p
            ...
            className="text-stone-300 text-base md:text-lg font-serif max-w-3xl leading-relaxed mb-8"
          >
            Khám phá 10 trải nghiệm du lịch Ladakh tuyệt vời nhất: chinh phục những cung đường cao nhất thế giới, ngắm dải ngân hà và gặp gỡ người du mục Himalaya.
          </motion.p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="font-serif text-3xl md:text-5xl font-bold tracking-tight text-stone-900">
              Cẩm Nang Khám Phá Ladakh Toàn Diện
            </h2>
            <div className="w-12 h-0.5 bg-amber-700 mx-auto mt-4 mb-4"></div>
          </div>

          
          <div className="space-y-6 text-stone-700 font-serif leading-relaxed text-base md:text-lg mb-12 text-justify prose-ladakh" dangerouslySetInnerHTML={{ __html: `<p>Nằm giữa dãy Himalaya hùng vĩ ở miền Bắc Ấn Độ, Ladakh là vùng đất của những ngọn núi cao phủ tuyết, các tu viện Phật giáo Tây Tạng cổ kính, những hồ nước xanh ngọc giữa cao nguyên và nền văn hóa bản địa được gìn giữ qua nhiều thế kỷ.</p>
<p>Nhưng điều khiến Ladakh trở thành điểm đến đặc biệt không chỉ nằm ở cảnh quan ngoạn mục. Đó còn là nơi du khách có thể chinh phục những cung đường cao nhất thế giới, ngắm bầu trời đầy sao giữa vùng đất gần như tách biệt với đô thị hiện đại, gặp gỡ các cộng đồng du mục trên cao nguyên và khám phá một nền văn hóa Himalaya vẫn hiện diện sống động trong đời sống hàng ngày.</p>
<p>Dưới đây là 10 <a href="https://thericetour.com/du-lich-ladakh" class="text-amber-700 font-semibold hover:text-amber-600 underline underline-offset-4 decoration-amber-700/30 transition-colors">trải nghiệm du lịch Ladakh</a> giúp bạn cảm nhận vùng đất này theo cách trọn vẹn hơn, vượt xa những bức ảnh check-in quen thuộc.</p>` }} />
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 bg-amber-50/75 border border-amber-900/10 rounded-2xl p-6 md:p-8">
            <div className="text-center">
              ...
              <div className="font-mono text-[10px] text-stone-600 uppercase tracking-wider mt-1">Đèo Khardung La</div>
            </div>
            <div className="text-center border-l border-amber-900/10">
              <div className="font-serif text-3xl md:text-4xl font-bold text-amber-800">4.200m</div>
              <div className="font-mono text-[10px] text-stone-600 uppercase tracking-wider mt-1">Hồ Pangong Tso</div>
            </div>
            <div className="text-center border-l sm:border-l border-amber-900/10 col-span-1">
              <div className="font-serif text-3xl md:text-4xl font-bold text-amber-800">Tây Tạng</div>
              <div className="font-mono text-[10px] text-stone-600 uppercase tracking-wider mt-1">Văn Hóa</div>
            </div>
            <div className="text-center border-l border-amber-900/10">
              <div className="font-serif text-3xl md:text-4xl font-bold text-amber-800">100%</div>
              <div className="font-mono text-[10px] text-stone-600 uppercase tracking-wider mt-1">Độ Tinh Khiết</div>
            </div>
          </div>
              ...
              >
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
                  ...
                  <div className={`lg:col-span-6 space-y-6 ${isEven ? 'lg:order-1' : 'lg:order-2'}`}>
                    ...
                    <p className="font-serif font-semibold text-stone-700 text-base md:text-lg leading-relaxed border-l-3 border-amber-700 pl-4 py-1 italic bg-amber-50/40 pr-3 rounded" dangerouslySetInnerHTML={{ __html: story.abstract }} />

                    
                    <div className="space-y-4 text-stone-700 text-base md:text-lg font-serif leading-relaxed text-justify prose-ladakh" dangerouslySetInnerHTML={{ __html: story.contentHTML }} />
                  ...
                  <div className={`lg:col-span-6 ${isEven ? 'lg:order-2' : 'lg:order-1'}`}>
                    <div className="bg-white p-4 pb-12 shadow-xl border border-stone-200/80 transform hover:rotate-1 hover:scale-[1.01] transition-all duration-300 relative inline-block w-full">
                      ...
                      {/* Frame container */}
                      <div className="aspect-4/3 overflow-hidden bg-stone-100 border border-stone-150 rounded-sm relative">
                        {story.imgUrl === 'CSS_STARS' ? (
                          <div className="absolute inset-0 bg-[#070b19] flex flex-col items-center justify-center overflow-hidden">
                            {/* SVG Noise & Gradient Background */}
                            <div 
                            ...
                            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[150%] h-[40%] bg-gradient-to-r from-transparent via-indigo-900/40 to-transparent -rotate-45 blur-3xl"></div>
                            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[150%] h-[20%] bg-gradient-to-r from-transparent via-purple-500/20 to-transparent -rotate-45 blur-2xl"></div>
                            
                            {/* Twinkling Stars */}
                            <div className="absolute top-[20%] left-[30%] w-0.5 h-0.5 bg-white rounded-full shadow-[0_0_4px_2px_rgba(255,255,255,0.8)] animate-pulse"></div>
                            <div className="absolute top-[70%] left-[60%] w-0.5 h-0.5 bg-white rounded-full shadow-[0_0_3px_1px_rgba(255,255,255,0.6)] animate-pulse" style={{ animationDelay: '1s' }}></div>
                            <div className="absolute top-[40%] left-[80%] w-1 h-1 bg-white rounded-full shadow-[0_0_5px_2px_rgba(255,255,255,0.9)] animate-pulse" style={{ animationDelay: '0.5s' }}></div>
                            <div className="absolute top-[80%] left-[20%] w-0.5 h-0.5 bg-white rounded-full shadow-[0_0_2px_1px_rgba(255,255,255,0.5)]"></div>
                            <div className="absolute top-[15%] left-[75%] w-0.5 h-0.5 bg-white rounded-full shadow-[0_0_2px_1px_rgba(255,255,255,0.7)] animate-pulse" style={{ animationDelay: '1.5s' }}></div>
                            <div className="absolute top-[60%] left-[15%] w-1 h-1 bg-white rounded-full shadow-[0_0_4px_1px_rgba(255,255,255,0.8)] animate-pulse" style={{ animationDelay: '0.2s' }}></div>
                            
                            {/* Elegant typography overlay */}
                            <div className="relative z-10 border border-white/20 p-5 bg-black/30 backdrop-blur-sm text-center transform -rotate-2 shadow-2xl">
                              <Sparkles className="w-5 h-5 text-indigo-300 mx-auto mb-2 opacity-80" />
                              <span className="text-indigo-50 font-serif text-sm tracking-widest uppercase block mb-1">Hanle Dark Sky</span>
                              <div className="w-8 h-[1px] bg-indigo-400/50 mx-auto mb-2"></div>
                              <span className="text-white/60 font-mono text-[8px] tracking-[0.2em] uppercase italic">Visualizing the Milky Way</span>
                            </div>
                          </div>
                        ) : (
                          <img
                      ...
                      <div className="mt-6 text-left pl-1">
                        <span className="font-serif text-[11px] text-amber-800 uppercase font-bold flex items-center gap-1.5 mb-1.5 font-mono">
                          ...
                          Trải Nghiệm Khó Quên Tại Himalaya
                        </span>
                        <p className="font-serif text-stone-700 italic text-sm leading-relaxed">
                          Chương {story.number}: Khám phá sự hùng vĩ và tĩnh lặng của vùng đất cực Bắc Ấn Độ.
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-end mb-16 pb-8 border-b border-stone-800">
            <div className="md:col-span-8">
              ...
              <h2 className="font-serif text-3xl md:text-5xl font-bold text-white leading-none tracking-tight">
                "Vượt Xa Những Bức Ảnh Check-in Quen Thuộc"
              </h2>
            </div>
      ...
      <footer className="bg-stone-950 text-white py-24 px-4 md:px-8 border-t border-amber-900/10 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <h3 className="font-serif text-3xl md:text-4xl font-bold tracking-tight text-white mb-6">
            Cảm Nhận Nhịp Sống Khác Biệt
          </h3>
          
          <p className="max-w-2xl mx-auto text-base md:text-lg font-serif italic text-stone-400 leading-relaxed mb-12 text-center">
            "Điều khiến tôi nhớ nhất về Ladakh không phải là một địa danh, mà là cảm giác mỗi buổi sáng thức dậy đều thấy cuộc sống diễn ra chậm hơn. Đó là trải nghiệm khó tìm thấy ở bất kỳ nơi nào khác."
          </p>
