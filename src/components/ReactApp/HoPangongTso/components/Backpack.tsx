      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="font-serif text-3xl md:text-4xl font-bold text-white tracking-tight leading-tight">
            Balo Đến Pangong Tso Cần Chuẩn Bị Những Gì?
          </h2>
          ...
          <p className="max-w-2xl mx-auto text-sm text-stone-400 font-sans">
            Nhiệt độ khắc nghiệt và độ cao 4.225m của hồ Pangong đòi hỏi sự chuẩn bị kỹ lưỡng. Đây là những vật dụng không thể thiếu giúp chuyến đi an toàn và trọn vẹn nhất.
          </p>
        </div>
