...
const REVIEWS = [
  {
    ...
    name: 'Phương Linh',
    date: 'Tháng 9, 2026',
    message: 'Nước hồ đổi màu thật vi diệu. Mình từng đến nhiều hồ nước đẹp trên thế giới nhưng vẻ hùng vĩ và tĩnh lặng của Pangong thực sự làm mình nghẹt thở!',
    likes: 124
  },
  {
    id: 2,
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="font-serif text-stone-400 italic">
            Cảm nhận từ những đôi chân từng đặt đến miền viễn biên Pangong Tso.
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          ...
          <p className="font-mono text-[10px] text-stone-500 uppercase mt-4 max-w-md mx-auto leading-relaxed">
            Pangong Tso - bức tranh ngoạn mục giữa lòng Himalaya. Từng con sóng nhỏ, từng tia nắng đều mang theo câu chuyện của thiên nhiên.
          </p>
        </div>
