    ...
    <section id="landscapes-section" className="scroll-mt-12 py-16 px-4 md:px-8 bg-white max-w-6xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between border-b border-gold-250 pb-6 mb-12">
        ...
        <div className="max-w-xs text-right">
          <span className="text-[10px] uppercase font-mono tracking-wider text-gold-500 block mb-1">Environmental Status</span>
          <span className="text-xs text-gold-800 font-light block leading-relaxed">
      ...
      <div className="bg-gold-50 border border-gold-200 rounded-2xl p-6 mb-10 max-w-2xl mx-auto text-center relative overflow-hidden shadow-sm">
        ...
        <span className="font-display font-bold text-xxs tracking-widest text-gold-600 block uppercase mb-1">
        ...
        <p className="text-xs text-gold-700 max-w-md mx-auto mb-5 leading-relaxed">
        ...
        <div className="flex flex-col items-center justify-center relative">
          ...
          <div className={`w-28 h-28 rounded-full border-2 border-gold-450 flex items-center justify-center transition-all duration-1000 ${
            ...
            <span className="font-display text-xxs font-bold text-gold-800 uppercase tracking-widest select-none">
          ...
          <button
            ...
            className={`mt-6 px-5 py-1.5 rounded-full font-display text-xxs font-bold uppercase tracking-widest cursor-pointer shadow-sm ${
              inhaleState === 'idle'
          ...
          >
            <div>
              ...
              <div className="relative aspect-3/2 rounded-xl overflow-hidden border border-gold-200/60 shadow-sm mb-4">
                ...
                <span className="absolute bottom-2 left-3 text-[10px] font-mono tracking-widest text-gold-200 uppercase">
                  {land.vibe}
                </span>
              </div>

              {/* Text metadata */}
              <span className="text-[10px] font-mono tracking-wider font-semibold text-gold-600 block mb-1">
                {land.vietnameseTitle}
              </span>
              <h3 className="font-serif text-xl font-bold text-gold-900 mb-2 tracking-tight">
                {land.title}
              </h3>
              <p className="text-xs text-gold-800 font-light leading-relaxed mb-4">
                {land.description}
              </p>
            </div>
            ...
            <div className="border-t border-gold-200 pt-3">
              {selectedId === land.id ? (
                <div className="bg-gold-100/60 p-3 rounded-lg border border-gold-250 mb-3 text-left">
                  <span className="font-display font-extrabold text-[9px] tracking-wider text-gold-700 block mb-1 uppercase flex items-center gap-1">
                    <BookOpen className="w-3 h-3" /> Truyền Thuyết Cổ Bản
                  </span>
                  <p className="text-xs text-gold-900 italic font-medium leading-relaxed">
                    {land.lore}
                  </p>
                </div>
              ) : null}
              ...
              <button
                ...
                className="flex items-center gap-1.5 text-[10px] font-display font-bold uppercase tracking-wider text-gold-800 hover:text-gold-900 cursor-pointer focus:outline-none"
              >
