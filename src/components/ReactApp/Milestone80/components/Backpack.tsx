    ...
    <section id="backpack-section" className="relative py-24 px-4 bg-stone-900 text-stone-150 border-t border-stone-800">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16 relative z-10">
          <span className="font-mono text-[10px] sm:text-xs text-amber-500 font-bold tracking-[0.2em] uppercase block mb-3 opacity-90">Sự Chuẩn Bị Chu Toàn</span>
          <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-black text-amber-50 drop-shadow-md">
            Hành Trang Thực Chiến Viễn Du
          </h2>
          <div className="w-16 h-0.5 bg-amber-500 mx-auto mt-6 mb-6"></div>
          <p className="max-w-2xl mx-auto text-base sm:text-base text-amber-100/80 font-sans leading-relaxed">
            Hành trang viễn du của FIT Tour là sự dung hòa giữa 
            những thiết bị y tế bảo hộ chuyên dụng nhất và sự tận tâm chăm chút ngọt ngào 
            mang hơi ấm quê hương đến từng nhịp thở của lữ khách giữa miền tuyết lạnh.
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-2 mb-10">
          {[
            ...
            { id: 'health', label: 'Hỗ Trợ Thích Nghi', icon: Heart },
                ...
                return (
                  ...
                  >
                    <div className="flex justify-between items-start mb-3">
                      ...
                      <span className="text-[10px] font-mono text-stone-300 font-semibold">{item.qty}</span>
                    </div>
                    ...
                    <div className="flex items-center justify-between text-xs font-mono">
                      <span className="text-stone-300">Độ cần thiết:</span>
            ...
            <div className="bg-stone-850 border border-stone-800 rounded-xl p-6 md:p-8 flex flex-col justify-between h-full relative overflow-hidden">
              ...
              {selectedItem ? (
                <div className="flex flex-col justify-between h-full">
                    ...
                    <div className="space-y-3 font-sans text-xs">
                      ...
                      <div className="flex justify-between py-2 border-b border-stone-800 text-stone-400">
                        ...
                        <span className="font-semibold text-white">
                          {selectedItem.category === 'health' ? '🛡️ Bảo vệ sức khỏe U70' : selectedItem.category === 'essential' ? '🎒 Tiện ích dã ngoại' : '❤️ Liệu pháp tâm lý'}
                        </span>
                      </div>
                  ...
                  <div className="pt-8 border-t border-stone-800 flex items-center justify-between text-xs font-mono text-stone-500">
                ...
                <div className="flex flex-col items-center justify-center text-center py-16 h-full">
                  ...
                  <p className="text-amber-100/60 font-sans text-xs max-w-[250px] mx-auto">
                    Hãy bấm vào một vật dụng bất kỳ trong kiện hàng dã ngoại để thấu hiểu sự chuẩn bị chu đáo và vai trò thực tế của nó trong thời tiết lạnh giá khắc nghiệt.
                  </p>
                </div>
              )}
