...
const CORE_COMMITMENTS = [
  {
    ...
    icon: Compass,
    content: "80 chuyến đi không chỉ là những con số trên giấy. Đó là 9 năm ròng rã tự mình trải đường, thấu rõ từng khúc cua đèo Khardung La, biết khi nào tuyết sẽ tràn đồi dốc, và biết khi nào lòng hồ muối Pangong đổi màu xanh ngọc lam rực rỡ nhất để đưa đoàn tới thưởng ngoạn.",
  ...
  },
  {
    ...
    icon: ShieldCheck,
    content: "Ladakh là vùng đất thanh bình nhưng khắc nghiệt gắt gao. Phụ huynh lớn tuổi U70 luôn lo sợ sập thở, nhưng với sự bọc sưởi điện và quy trình tầm soát y tế 3 lớp của Fit Tour, mọi nỗi lo sợ đều được chuyển hóa thành những ký ức rực rỡ tuyệt vời.",
...
const VOYAGE_MILESTONES = [
  {
    ...
    achievement: "Thành lập văn phòng liên minh cốt lõi trực tiếp ngay tại trung tâm Leh Ladakh."
  },
  {
    era: "2019 – 2022",
  ...
  },
  {
    ...
    desc: "Thiết lập hệ thống lều VIP bọc vách cách nhiệt, trang bị chăn đệm sưởi ấm điện rực giữa đêm lạnh âm 10 độ tại bờ hồ huyền thoại Pangong Tso.",
  ...
  },
  {
    ...
    desc: "Khẳng định vị thế thủ lĩnh lữ hành Ladakh uy tín hàng đầu Việt Nam. Nơi trải nghiệm thực địa được kết tinh thành nghệ thuật phục tùng đỉnh cao.",
    achievement: "Cán mốc 80 chuyến đi dã ngoại Ladakh rực rỡ, thiết lập chuẩn an toàn 5 Lớp mới."
  }
];
...
const SAFETY_INFRASTRUCTURE = [
  ...
  },
  {
    ...
    desc: "100% xe SUV của Fit Tour vận hành qua các đèo Khardung La, Chang La đều trang bị hệ thống sục khí oxy chuyên dụng túc trực 24/7.",
  ...
  },
  {
    ...
    desc: "Cách ly hoàn toàn với cái lạnh tàn khốc của sa mạc. Toàn bộ phòng khách sạn tại Leh có sưởi sàn trung tâm; các lều trại Pangong sưởi đệm ấm áp rực hồng.",
...
const ELITE_TOURS = [
  ...
  {
    id: "tour-adventure",
    title: "Chinh Phục Đại Đèo Khardung La & Pangong",
    ...
    highlight: "Điểm nhấn của kỷ lục 80 chuyến"
  },
  {
    id: "tour-spiritual",
    ...
    features: [
      ...
      "Thưởng ngoạn dòng ngã ba sông hòa quyện Indus - Zanskar"
    ],
...
const TRAVEL_TESTIMONIALS = [
  {
    ...
    quote: "Trước đi cả nhà can ngăn bảo già rồi leo đèo 5.300m làm sao nổi. Nhưng đồng hành với Fit Tour, tôi thấy tim mình đập rất êm. Xe SUV có bình oxy sục ấm áp, tối ngủ lều Pangong chăn điện ấm hừng hực. 80 chuyến đi của các bạn là hoàn toàn xứng đáng với sự cẩn trọng xuất sắc ấy!"
  },
  {
  ...
  },
  {
    ...
    quote: "Hồi đầu tôi lo sợ Ladakh hoang dã làm cơ thể rã rời, nhưng Fit tour chia lịch thong thong, hai ngày đầu chỉ ngủ tĩnh dưỡng ở Leh. Nhờ thế tôi khỏe re cưỡi lạc đà sa mạc Nubra cát lạnh, ngắm rặng tuyết vĩnh cửu như mơ. Chúc mừng các cháu cán mốc 80 chuyến viễn du thành công rực rỡ!"
  }
];
...
export default function PillarGuide({ onTourSelect }: PillarGuideProps) {
  ...
  const handleAddToast = (e: React.FormEvent) => {
    ...
    const newToast = {
      ...
      author: `${customToast.name} (Hành khách gửi lời mừng 80 chuyến)`,
  ...
  return (
    <div className="bg-stone-950 text-stone-100 min-h-screen text-left" id="eeat-landmark-hub">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-end">
            <div className="lg:col-span-8 space-y-6">
              ...
              <p className="font-serif text-lg sm:text-2xl text-stone-300 leading-relaxed max-w-3xl italic font-light">
                “80 hành trình khởi hành qua muôn trùng bão cát và đèo tuyết của Ladakh không chỉ chứng minh quy mô. 
            ...
            <div className="lg:col-span-4 space-y-2.5">
              ...
              <div className="mt-6 p-4 bg-amber-500/5 border border-amber-500/10 rounded-2xl relative overflow-hidden">
                ...
                <p className="text-xs text-stone-400 leading-normal italic">
                  &quot;Ladakh hoang dại đẹp mê hồn nhưng không dung túng cho sự hời hợt. Khi đồng hành cùng FIT Tour, bạn đặt niềm tin vào thực chiến 80 chuyến đi bảo vệ gia đình mình.&quot;
                </p>
              </div>
            </div>
      ...
      <section className="py-24 px-4 md:px-8 bg-stone-900/20 border-b border-stone-900 text-left">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="max-w-3xl mb-16 space-y-3">
            ...
            <p className="text-stone-400 text-base sm:text-base leading-relaxed">
              Mốc 80 chuyến đi không tự dưng có được sau một đêm. Đó là một chặng tiến hóa bền bỉ về quy chuẩn hậu cần từ thủ công tự phát lên y khoa bọc quân khí:
            </p>
          </div>
      ...
      {/* ======================================================================
          ...
          Chứng minh giải pháp thực tế Fit Tour đã vận hành thành công 80 chuyến qua
          ====================================================================== */}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
            ...
            <p className="text-stone-400 text-base sm:text-base leading-relaxed">
              ...
              đã đồng hành cùng 80 chuyến đi hoàn mỹ bảo chứng sinh mệnh cho phượt thủ Fit Tour:
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-stretch">
            ...
            <div className="p-8 rounded-3xl bg-gradient-to-br from-amber-600 to-orange-700 text-stone-950 flex flex-col justify-between items-start col-span-1 md:col-span-2 lg:col-span-1 border border-amber-500/20 shadow-xl">
              ...
              <button
                onClick={() => {
                  onTourSelect?.({
                    title: "Bản đồ An toàn Y tế & Lịch thích nghi U70 Ladakh",
      ...
      <section id="elite-tours-catalog" className="py-24 px-4 md:px-8 bg-stone-950 relative border-b border-stone-900 text-left">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
            ...
            <h2 className="font-serif text-3xl sm:text-5xl font-black text-white tracking-tight">
              Tuyển Tập Hành Trình Ladakh Tinh Hoa
            </h2>
              ...
              {!toastSubmitted ? (
                <form onSubmit={handleAddToast} className="space-y-4 text-xs font-sans">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="Khac">Người thích Ladakh</option>
                      </select>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <textarea 
                      ...
                      placeholder="Chúc mừng Fit Tour đạt mốc vàng 80 chuyến! Lòng tin của gia đình tôi gửi gắm nơi các bạn..."
                ...
                >
                  ...
                  <p className="text-xs text-stone-300 leading-relaxed">
                    Lời chúc đã được phong lên ban đầu bảng danh vị kỷ niệm 80 năm Ladakh của Fit Tour. Cảm xúc chân thành của quý bạn là chất xúc tác để Fit Tour phấn đấu cán mốc 150 đoàn rực rỡ!
                  </p>
                  <button
      ...
      <section className="py-24 px-4 md:px-8 bg-stone-950 text-left border-b border-stone-900">
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="space-y-3">
            {[
              {
                q: "Vì sao con số 80 chuyến đi là nhân tố đảm bảo chống AMS (Sốc cao) tối cao?",
              ...
              {
                q: "Kỷ lục 80 chuyến đi của Fit Tour bao gồm những nhóm hành khách nào?",
              ...
              {
                q: "Pháp lý lữ hành của Fit Tour khi liên doanh cứu hộ Ladakh là như thế nào?",
                a: "Fit Tour là thành viên chính thức IATO, được cấp phép độc quyền khai thác lữ hành biên giới Jammu - Kashmir và Ladakh. Nhờ danh vị uy tín bền bỉ suốt 9 năm cùng 80 chuyến bay giải ngân hành khách, chúng tôi có hiệp ước hỗ trợ ưu tiên trực thăng quân đoàn của quân y Bắc Ấn và bệnh viện SNM Hospital Leh."
              }
            ].map((item, idx) => (
              <div 
                key={idx}
