...
const CINEMATIC_CHAPTERS = [
  {
    ...
    hook: "80 Chuyến Đi Tuyệt Đối Không Sự Cố Tại Ladakh",
    desc: "Suốt một thập kỷ băng sương, người dẫn đầu của Fit Tour không đọc thông tin qua mặt giấy. Chúng tôi ngửi thấy gió bấc đang dồn về thung lũng Nubra, thấu suốt nhịp thở nông sâu của đá mỏi bên đường đèo Khardung La. Trực giác dạn dày là dải radar an toàn vững chãi nhất cho cha mẹ bạn.",
  ...
  },
  {
    ...
    hook: "Ấm Áp Sưởi Nhiệt Glamping Âm 10 Độ Pangong",
    desc: "Bản lĩnh của chuyến đi thứ 80 là hiện thực hóa giấc mơ ngắm dải vũ trụ Milky Way lộng lẫy bên hồ Pangong giá lạnh âm 10 độ cho những lữ khách U70 gối mỏi. Bằng lều sưởi nhiệt điện ấm sực hai lớp cao cấp, trà gừng hâm nóng liên hoàn, kẹp sát sức khỏe trong lòng bàn tay hậu cần chu đáo tỉ mỉ.",
...
const FILMIC_TOURS = [
  {
    ...
    features: [
      "Vượt đỉnh đèo Khardung La (5.359m) thung thăng ung dung",
        ...
        <div className="relative z-20 max-w-6xl mx-auto w-full px-4 sm:px-8 pb-12 sm:pb-24 grid grid-cols-1 lg:grid-cols-12 gap-8 items-end">
          ...
          <div className="lg:col-span-4 bg-black/60 backdrop-blur-lg border border-stone-850 p-6 rounded-2xl space-y-4 shadow-lg">
            ...
            <div className="text-[10px] text-stone-500 leading-normal text-justify pt-1 font-mono">
              ...
              Thực nghiệm 80 chuyến đi là nguồn cảm hứng nghệ thuật đỉnh cao của chúng tôi. Hãy bách lãm để thấu suốt bản ngã Ladakh hiểm trở.
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-3">
            ...
            <p className="text-stone-400 font-sans text-base sm:text-base italic leading-relaxed">
              Trải nghiệm độ cao nguy cơ cao của Ladakh qua góc ngắm góc chụp camera. Kéo thước đo thấu kính để đo sinh thốn huyết áp bố mẹ U70:
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div className="lg:col-span-5 bg-black border border-stone-850 p-6 rounded-2xl flex flex-col justify-between space-y-6 shadow-inner">
              ...
              <div className="p-4 bg-stone-900 border-l-2 border-amber-500 text-stone-400 text-xs italic font-sans leading-relaxed rounded-r-lg">
                ...
                {hudOxygenShield ? (
                  <span>“Đoàn thứ 80 vừa qua mang theo 14 bố mẹ lớn tuổi, nhờ quy trình bọc sưởi ấm nóng Pangong và túc trực bình nén khí, nhịp phế thở của các cụ đều giữ trơn mộc mọc.”</span>
                ) : (
