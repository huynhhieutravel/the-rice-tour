      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="font-serif text-3xl md:text-5xl font-bold tracking-tight text-white mb-6">
            Balo Đến Thung Lũng Zanskar Cần Chuẩn Bị Những Gì?
          </h2>
          <div className="w-16 h-0.5 bg-amber-500 mx-auto mt-4 mb-4"></div>
          <p className="font-serif text-stone-300 max-w-2xl text-sm md:text-base leading-relaxed">
            Độ cao trung bình khoảng 3.500–4.000 m cùng thời tiết khắc nghiệt và vị trí xa xôi của thung lũng Zanskar đòi hỏi sự chuẩn bị kỹ lưỡng. Đây là những vật dụng không thể thiếu giúp chuyến đi an toàn và trọn vẹn nhất.
          </p>
        </div>
