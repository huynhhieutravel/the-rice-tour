...
const REVIEWS = [
  {
    ...
    name: 'Phương Linh',
    date: 'Tháng 9, 2026',
    message: 'Đứng trên sân thượng tu viện nhìn xuống thung lũng Doda bao la thực sự là một cảm giác không thể quên. Sự tĩnh lặng của Stongdey khiến mọi mệt mỏi đường dài tan biến!',
    likes: 124
  },
  {
    id: 2,
    name: 'Hoàng Quân',
    date: 'Tháng 8, 2026',
    message: 'Mình rất ấn tượng với những bức bích họa cổ trong chánh điện và sự thân thiện của các vị sư. Các chú tiểu sư ở đây đáng yêu vô cùng, nụ cười trong trẻo xua tan cái lạnh giá của Zanskar.',
    likes: 89
  },
  {
    id: 3,
    name: 'Bích Ngọc',
    date: 'Tháng 7, 2026',
    message: 'Khác hẳn với vẻ tấp nập ở các tu viện quanh Leh, Stongdey mang một nhịp sống chậm rãi và thanh tịnh. Tham dự buổi đọc kinh sáng cùng chư tăng là một trải nghiệm tâm linh tuyệt vời.',
    likes: 210
  }
];
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="font-serif text-stone-400 italic">
            Cảm nhận từ những đôi chân từng đặt đến miền viễn biên Tu viện Stongdey.
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          ...
          <p className="font-mono text-[10px] text-stone-400 uppercase mt-4 max-w-md mx-auto leading-relaxed">
            Tu viện Stongdey - chốn an yên trên đỉnh cao Zanskar. Nơi những lời kinh hòa vào gió ngàn và tuyết trắng.
          </p>
        </div>
