      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="font-serif text-3xl md:text-4xl font-bold text-white tracking-tight leading-tight">
            Balo Đến Đèo Umling La Cần Chuẩn Bị Những Gì?
          </h2>
          <div className="w-16 h-0.5 bg-amber-500 mx-auto mt-4 mb-4"></div>
          <p className="text-stone-400 font-serif italic text-sm md:text-base max-w-xl mx-auto">
            Nhiệt độ khắc nghiệt và độ cao 5.883m của đỉnh đèo Umling La đòi hỏi sự chuẩn bị kỹ lưỡng. Đây là những vật dụng không thể thiếu giúp chuyến đi an toàn và trọn vẹn nhất.
          </p>
        </div>
