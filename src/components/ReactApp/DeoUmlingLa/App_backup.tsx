...
export default function App() {
  ...
  const PORTRAIT_COVERS = [
    {
      title: "MẶT HỒ ĐỔI MÀU",
      vibe: "Xanh ngọc bích rực rỡ",
      imageUrl: "https://media.fittour.vn/uploads/2022/06/khach-du-lich-di-ben-ho-pangong-tso.webp",
      quote: "Mặt nước hồ như một tấm gương khổng lồ phản chiếu bầu trời, liên tục đổi màu theo từng khoảnh khắc trong ngày.",
      badge: "TRẢI NGHIỆM",
    ...
    },
    {
      ...
      quote: "Tận hưởng sự ấm áp giữa đêm đông buốt giá trong những chiếc lều Glamping cao cấp biệt lập.",
      badge: "LƯU TRÚ",
    ...
    {
      title: "GÓC ĐIỆN ẢNH",
      vibe: "Check-in bối cảnh phim",
      imageUrl: "https://media.fittour.vn/uploads/ho-pangong-duoi-bau-troi-xanh-ladakh.webp",
      quote: "Không chỉ là bối cảnh của những bộ phim bom tấn, Pangong ngoài đời thực còn choáng ngợp và hùng vĩ hơn gấp nhiều lần.",
      badge: "SỐNG ẢO",
    ...
    <div className="min-h-screen bg-stone-50 text-stone-800 font-sans selection:bg-amber-150 selection:text-amber-900 overflow-x-hidden antialiased">
      ...
      <header className="relative min-h-[100dvh] flex flex-col justify-between items-center bg-stone-950 text-white overflow-hidden p-6 md:p-8">
        ...
        <div className="absolute inset-0 z-0">
          <img
            src="https://media.fittour.vn/uploads/2024/06/canh-quan-hoang-so-ho-pangong.webp"
            alt="Hồ Pangong Tso lúc bình minh"
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto my-auto flex flex-col items-center">
          ...
          <div className="font-serif text-3xl md:text-4xl lg:text-5xl font-bold text-white tracking-tight leading-tight mb-6 text-center">
            ...
            >
              Hồ Pangong Tso - Khám phá vẻ đẹp hồ thiêng Ladakh và kinh nghiệm đi
            </h1>
          </div>
          ...
          >
            Trọn bộ kinh nghiệm du lịch thực tế chinh phục Hồ Pangong Tso - đại dương trên mây kỳ vĩ của vùng đất Ladakh. Cẩm nang tóm gọn lịch trình di chuyển, cách phòng tránh say độ cao và trải nghiệm lưu trú Glamping cao cấp bên bờ hồ nước mặn cao nhất thế giới.
          </motion.p>
          ...
          >
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span>Điểm đến: <b>Hồ Pangong Tso</b></span>
            </div>
            <span className="hidden sm:inline text-white/20">|</span>
            <div className="flex items-center gap-1.5">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="font-serif text-3xl md:text-5xl font-bold tracking-tight text-stone-900">
              Tổng quan vùng viễn biên Pangong Tso
            </h2>
          ...
          <div className="space-y-6 text-stone-700 font-serif leading-relaxed text-base md:text-lg mb-12 text-justify">
            <p className="drop-cap">
              Những chia sẻ dưới đây được đúc kết từ chuyến đi thực tế của tôi trong quá trình khảo sát và thiết kế các hành trình du lịch tại FIT Tour. Đứng trước vẻ đẹp siêu thực của Pangong Tso, tôi nhận ra rằng một chuyến đi trọn vẹn không chỉ là việc check-in tại những điểm nổi tiếng, mà là nghệ thuật tận hưởng sự tĩnh lặng và hòa mình vào thiên nhiên ngoạn mục.
            </p>
            <p>
              Khác với những bài viết cẩm nang phượt tự túc, bài viết này không nói về sự khắc nghiệt hay thiếu thốn. Với định hướng du lịch cao cấp Bespoke, những kinh nghiệm chia sẻ ở đây sẽ giúp bạn chuẩn bị tốt nhất để thưởng thức vẻ đẹp của "Đại dương trên mây" một cách an tâm tuyệt đối. Đặc biệt, nhằm xua tan nỗi lo <a href="/say-do-cao-ladakh" className="text-amber-600 hover:text-amber-700 underline decoration-amber-500/30 underline-offset-2">say độ cao (AMS)</a>, FIT Tour luôn bố trí sẵn bình oxy y tế phục vụ du khách ngay tại các khu <a href="/sama-resort-pangong" className="text-amber-700 hover:text-amber-800 underline decoration-amber-500/30 underline-offset-2 font-semibold">Luxury Glamping như Sama Resort</a>, đảm bảo một đêm nghỉ dưỡng tiện nghi và an toàn nhất.
            </p>
          </div>
          ...
          <div className="bg-amber-50/50 border-l-4 border-amber-500 p-6 md:p-8 rounded-r-2xl mb-12 shadow-sm">
            ...
            <ul className="space-y-3 font-sans text-sm md:text-base text-stone-700">
              <li className="flex items-start gap-3"><span className="text-amber-500 font-bold mt-0.5">•</span> <b>Thời điểm lý tưởng:</b> Tháng 6 đến giữa tháng 9 khi thời tiết ấm áp, hồ tan băng hoàn toàn.</li>
              <li className="flex items-start gap-3"><span className="text-amber-500 font-bold mt-0.5">•</span> <b>Giấy phép:</b> Bắt buộc phải xin Inner Line Permit (ILP) vì đây là khu vực sát biên giới.</li>
              <li className="flex items-start gap-3"><span className="text-amber-500 font-bold mt-0.5">•</span> <b>Sức khỏe:</b> Yêu cầu phải ở Leh (độ cao 3.500m) ít nhất 2 đêm để cơ thể thích nghi trước khi qua đèo Chang La (5.360m) đến hồ.</li>
            </ul>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 bg-amber-50/75 border border-amber-900/10 rounded-2xl p-6 md:p-8">
            <div className="text-center">
              <div className="font-serif text-3xl md:text-4xl font-bold text-amber-800">4.225m</div>
            ...
            <div className="text-center border-l border-amber-900/10">
              <div className="font-serif text-3xl md:text-4xl font-bold text-amber-800">134km</div>
            ...
            <div className="text-center border-l sm:border-l border-amber-900/10 col-span-1">
              <div className="font-serif text-3xl md:text-4xl font-bold text-amber-800">60%</div>
              <div className="font-mono text-[10px] text-stone-600 uppercase tracking-wider mt-1">Nằm ở Tây Tạng</div>
            </div>
            <div className="text-center border-l border-amber-900/10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-end mb-16 pb-8 border-b border-stone-800">
            <div className="md:col-span-8">
              ...
              <h2 className="font-serif text-3xl md:text-5xl font-bold text-white leading-none tracking-tight">
                "Vẻ Đẹp Đổi Màu Của Hồ Pangong Tso"
              </h2>
            </div>
            ...
            <div className="lg:col-span-3 space-y-8 order-2 lg:order-1">
              ...
              <div className="space-y-3 font-mono text-xs text-stone-400">
                ...
                <div className="flex justify-between py-1.5 border-b border-stone-900">
                  ...
                  <span className="text-white font-semibold">Pangong Tso</span>
                </div>
                <div className="flex justify-between py-1.5 border-b border-stone-900">
              ...
              <div className="bg-stone-900/60 border border-stone-800 p-4 rounded-xl font-mono text-xs text-stone-300 space-y-2">
                ...
                <div>
                  <span className="text-stone-400 text-[10px] uppercase block">Pangong GPS Point</span>
      ...
      <footer className="bg-stone-950 text-white py-24 px-4 md:px-8 border-t border-amber-900/10 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="max-w-2xl mx-auto text-sm md:text-base font-serif italic text-stone-400 leading-relaxed mb-12 text-center">
            "Hãy giữ ấm tuyệt đối và luôn đi cùng hướng dẫn viên của FIT Tour để đảm bảo an toàn sức khỏe. Pangong Tso không chỉ là một điểm ngắm cảnh, đó là một hành trình vượt qua giới hạn bản thân để chạm đến vẻ đẹp siêu thực."
          </p>
